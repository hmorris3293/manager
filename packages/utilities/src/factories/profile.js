...
exports.sshKeyFactory = exports.userPreferencesFactory = exports.securityQuestionsFactory = exports.profileFactory = void 0;
var factoryProxy_1 = require("./factoryProxy");
exports.profileFactory = factoryProxy_1.Factory.Sync.makeFactory({
...
exports.securityQuestionsFactory = factoryProxy_1.Factory.Sync.makeFactory({
    security_questions: [
        ...
        {
            id: 6,
            question: 'What is the name of a college you applied to but did not attend?',
            response: null,
        },
        {
            id: 7,
...
exports.userPreferencesFactory = factoryProxy_1.Factory.Sync.makeFactory({
