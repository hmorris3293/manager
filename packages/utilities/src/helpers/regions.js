...
exports.getRegionsByRegionId = void 0;
/**
 ...
 */
var getRegionsByRegionId = function (regions) {
    if (!regions) {
        return {};
    }
    return regions.reduce(function (lookup, region) {
        lookup[region.id] = region;
        return lookup;
    }, {});
};
exports.getRegionsByRegionId = getRegionsByRegionId;
