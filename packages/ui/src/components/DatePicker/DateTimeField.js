...
var DateTimeField = function (_a) {
    var errorText = _a.errorText, _b = _a.format, format = _b === void 0 ? 'yyyy-MM-dd hh:mm a' : _b, // Default format includes time
    ...
    return (<LocalizationProvider_1.LocalizationProvider dateAdapter={AdapterLuxon_1.AdapterLuxon}>
      <Box_1.Box display="flex" flexDirection="column" sx={sx}>
        ...
        <DateTimeField_1.DateTimeField format={format} inputProps={{
