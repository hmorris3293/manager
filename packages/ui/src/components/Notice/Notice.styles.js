...
exports.useStyles = (0, mui_1.makeStyles)()(function (theme) { return ({
    error: {
        borderLeft: "4px solid ".concat(theme.tokens.component.NotificationBanner.Error.Border),
    ...
    info: {
        borderLeft: "4px solid ".concat(theme.tokens.component.NotificationBanner.Informative.Border),
        background: theme.tokens.component.NotificationBanner.Informative.Background,
        '& path': {
    ...
    root: {
        ...
        alignItems: 'center',
        '& + .notice': {
            marginTop: "".concat(theme.spacingFunction(16), " !important"),
        },
        borderRadius: 1,
        padding: "10px ".concat(theme.spacingFunction(12)),
        '& .MuiTypography-root': {
            width: '100%',
        },
        '& p': {
    ...
    success: {
        borderLeft: "4px solid ".concat(theme.tokens.component.NotificationBanner.Success.Border),
    ...
    warning: {
        borderLeft: "4px solid ".concat(theme.tokens.component.NotificationBanner.Warning.Border),
